...
このJSONに含まれるもの：指示力パターン（6軸）・件数
含まれないもの：コードの内容・固有名詞・技術的な実装詳細

サーバーコードはこちらで確認できます：https://github.com/thought-analyzer/thought-analyzer
送信先：https://thought-analyzer.ai-hapi-blog.workers.dev/collect
